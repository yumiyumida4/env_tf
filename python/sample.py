...
_url = 'https://storage.googleapis.com/download.tensorflow.org/example_images/flower_flower_photos.tgz'
...
#1エポックあたりステップ数
steps_per_epoch = np.ceil(image_data.samples/image_data.bath_size)
